...
export const NeumorphicButtons: React.FC = () => {

  const [ isSelected, setIsSelected ] = React.useState<string>();

  return (
    <div 
      className={ css.neumorphicButtons }>
      
      <div 
        className={ css.neumorphicButtons_buttonGroup }>
      ...
      <div 
        className={ css.neumorphicButtons_credits }>
